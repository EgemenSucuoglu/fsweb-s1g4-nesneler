...
*/
console.log(MenuElemaniOlustur("Sprite, 5, Icecekler"));
console.log(MenuElemaniOlustur("Burger", "20", "Fastfood"));
console.log(MenuElemaniOlustur("Pide", "15", "Fırın"));
...
*/
const Ahmet = degerlendirmeler[5];
console.log(Ahmet);
...
*/
degerlendirmeler[7].geribildirim = ["Bu mekanbir harika"];
...
function DegerledirmeEkle(degerlendirmeler, isim, puan, geribildirim) {
  const yenıDegerlendırme = {
    isim: isim,
    puan: 2,
    geribildirim: geribildirim,
  };
  degerlendirmeler.push(yenıDegerlendırme);
  return degerlendirmeler;
}
console.log(DegerledirmeEkle(degerlendirmeler, Hasan, 8, "çok güzel"));
/*  Görev 6: 
